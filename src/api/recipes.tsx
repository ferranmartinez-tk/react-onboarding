...
export const postRecipe = async (newRecipe: Recipe): Promise<Recipe> => {
    try {
        ...
        const recipe: Recipe = {
            ...
            ingredients: data.ingredients.map((ingredient: IngredientSchema) => ingredient.id)
        };
        return recipe;
    } catch (exception) {
...
export const getRecipes = async (): Promise<RecipeListItem[]> => {
    try {
        ...
        const recipes: RecipeListItem[] = data.recipes.map((recipe: RecipeListItemSchema) => ({
            id: recipe.id,
            name: recipe.name,
...
export const putRecipe = async (recipeID: string, newRecipe: Recipe): Promise<Recipe> => {
...
export const deleteRecipe = async (recipeID: string) => {
    ...
    try {
        ...
        throw Error(`Error calling DELETE METHOD on: ${deleteRecipeURL} ` + exception);
    }
};
...
export const getIngredients = async (): Promise<Ingredient[]> => {
    try {
        ...
        const ingredients: Ingredient[] = data.ingredients.map((ingredient: IngredientSchema) => ({
